...
from blog.views import BlogRecordListView, BlogRecordDetailView, BlogRecordCreateView, BlogRecordUpdateView, \
    BlogRecordDeleteView

app_name = BlogConfig.name

urlpatterns = [path('', BlogRecordListView.as_view(), name='records_list'),
